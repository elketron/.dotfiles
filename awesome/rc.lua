...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "a", function () awful.spawn(rofi_launch) end,
              {description = "launch program launcher", group = "launcher"}),
    awful.key({ modkey, "Shift"   }, "a", function () awful.spawn(screenshot) end,
    ...
    awful.key({ modkey,           }, "w", function () awful.spawn(rofi_win) end,
              {description = "open window modi in rofi", group = "launcher"}),
    awful.key({ modkey, "Control" }, "q", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey, "Shift"   }, "x", awful.spawn(rofi_powermenu),
              {description = "open rofi_powermenu", group = "launcher"}),
